...
void i_binary_expand_op(const emlrtStack *sp, emxArray_real_T *in1,
                        ...
                        const real_T in9[111], real_T in10,
                        const real_T in11[1554], const emxArray_real_T *in12)
{
  emlrtStack st;
  real_T b_in9[111];
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] = in9[i] +
               in10 * ((((((((2.1573890074940536 * in11[i] +
                            ...
                            13.139130397598764 * in11[i + 111]) +
                           -2.6044157092877147 * in11[i + 222]) +
                          -5.1938599497838727 * in11[i + 333]) +
                         -20.412340711541507 * in11[i + 444]) +
                        -12.300856252505723 * in11[i + 555]) +
                       1.5215530950085394 * in11[i + 666]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] =
        ...
        in10 * (((((((((-1.2116979103438739 * in11[i] +
                      ...
                      -6.9139169691784579 * in11[i + 111]) +
                     -0.676462266509498 * in11[i + 222]) +
                    3.3678604450266079 * in11[i + 333]) +
                   18.006751643125909 * in11[i + 444]) +
                  6.83882892679428 * in11[i + 555]) +
                 -1.0315164519219504 * in11[i + 666]) +
                0.41291062321306227 * in11[i + 777]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] = in9[i] +
               in10 * ((((((((0.6130118256955932 * in11[i] +
                            ...
                            1.7907333894903747 * in11[i + 111]) +
                           0.714927166761755 * in11[i + 222]) +
                          -1.438580857841723 * in11[i + 333]) +
                         -8.26332931206474 * in11[i + 444]) +
                        -1.5375705708088652 * in11[i + 555]) +
                       0.34538328275648716 * in11[i + 666]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] = in9[i] +
               in10 * (((((((-0.50746350564169751 * in11[i] +
                           ...
                           -0.49526123800360955 * in11[i + 111]) +
                          0.29325255452538868 * in11[i + 222]) +
                         1.440108693768281 * in11[i + 333]) +
                        6.2379344986470562 * in11[i + 444]) +
                       0.72701920545269871 * in11[i + 555]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] =
        in9[i] + in10 * ((((((-0.036284233962556589 * in11[i] +
                            ...
                            0.070822544441706839 * in11[i + 111]) +
                           -0.023136470184824311 * in11[i + 222]) +
                          0.27112047263209327 * in11[i + 333]) +
                         1.3081337494229808 * in11[i + 444]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] =
        in9[i] + in10 * (((((-0.026091134357549235 * in11[i] +
                           ...
                           0.034346641183686168 * in11[i + 111]) +
                          0.1595758283215209 * in11[i + 222]) +
                         0.21408573218281934 * in11[i + 333]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
  ...
  for (i = 0; i < 111; i++) {
    b_in9[i] =
        in9[i] + in10 * ((((0.048226773224658105 * in11[i] +
                          ...
                          -0.021520063204743093 * in11[i + 111]) +
                         -0.10453742601833482 * in11[i + 222]);
  }
  st.site = (emlrtRSInfo *)&in2;
  objfun_suff_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
}
