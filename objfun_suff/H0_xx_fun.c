...
void H0_xx_fun(const emlrtStack *sp, const real_T in1_data[], int32_T in1_size,
               const real_T in2_data[], int32_T in2_size, real_T d2H0_dxdx[25])
{
  emlrtStack b_st;
  emlrtStack st;
  real_T b_t41_tmp;
  ...
  if (in2_size < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2_size, &id_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2_size < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, 3, &hd_emlrtBCI, (emlrtConstCTX)sp);
  }
  if (in1_size < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1_size, &gd_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1_size < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, 1, &fd_emlrtBCI, (emlrtConstCTX)sp);
  }
  t2 = in1_data[0] * 2.0;
  st.site = &ue_emlrtRSI;
