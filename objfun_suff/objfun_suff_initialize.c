 ...
 *
 * objfun_suff_initialize.c
 *
 * Code generation for function 'objfun_suff_initialize'
 *
 */
...
static void objfun_suff_once(const emlrtStack *sp);
...
void objfun_suff_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
...
/* End of code generation (objfun_suff_initialize.c) */
