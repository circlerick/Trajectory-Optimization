% OBJFUN_S_TIME_SCRIPT   Generate MEX-function objfun_S_time_mex from
%  objfun_S_time.
% 
% Script generated from project 'objfun_S_time.prj' on 25-Jul-2024.
% 
...
%% Define argument types for entry-point 'objfun_S_time'.
ARGS = cell(1,1);
ARGS{1} = cell(5,1);
...
codegen -config cfg objfun_S_time -args ARGS{1}
