 ...
 *
 * objfunSTM_S_energy_data.c
 *
 * Code generation for function 'objfunSTM_S_energy_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "objfunSTM_S_energy",                                 /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
/* End of code generation (objfunSTM_S_energy_data.c) */
