                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  emxInit_real_T(sp, &r, 1, &de_emlrtRTEI);
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_energy_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, r);
  b_in9_data = r->data;
                        ...
                        const emxArray_real_T *in13)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &sd_emlrtRTEI);
  i = b_in9->size[0];
  if (in11->size[0] == 1) {
    if (in13->size[0] == 1) {
      if (in12->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &sd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  ...
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_energy_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
  emxFree_real_T(sp, &b_in9);
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtConstCTX)sp);
}
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &qd_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &qd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &pd_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &pd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &od_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &od_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &nd_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &nd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &md_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &md_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &ld_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &ld_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &kd_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &kd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &jd_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    if (in11->size[0] == 1) {
      stride_0_0 = in1->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &jd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in13)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &id_emlrtRTEI);
  i = b_in9->size[0];
  if (in13->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in1->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &id_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in13)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &hd_emlrtRTEI);
  i = b_in9->size[0];
  if (in13->size[0] == 1) {
    if (in12->size[0] == 1) {
      stride_0_0 = in11->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &hd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in12->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &gd_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    if (in1->size[0] == 1) {
      stride_0_0 = in11->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &gd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in1->size[0] != 1);
                        ...
                        const emxArray_real_T *in12)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &fd_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    stride_0_0 = in11->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &fd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in12->size[0] != 1);
                        ...
                        const emxArray_real_T *in11)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &ed_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    stride_0_0 = in11->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &ed_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in1->size[0] != 1);
                        ...
                        const emxArray_real_T *in11)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &dd_emlrtRTEI);
  i = b_in9->size[0];
  b_in9->size[0] = in11->size[0];
  emxEnsureCapacity_real_T(sp, b_in9, i, &dd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  loop_ub = in11->size[0];
  for (i = 0; i < loop_ub; i++) {
