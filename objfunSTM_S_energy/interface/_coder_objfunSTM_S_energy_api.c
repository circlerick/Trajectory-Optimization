 ...
 *
 * _coder_objfunSTM_S_energy_api.c
 *
 * Code generation for function '_coder_objfunSTM_S_energy_api'
 *
 */
...
static emlrtRTEInfo cd_emlrtRTEI = {
    1,                               /* lineNo */
    1,                               /* colNo */
    "_coder_objfunSTM_S_energy_api", /* fName */
    ""                               /* pName */
};
...
void objfunSTM_S_energy_api(const mxArray *const prhs[4], int32_T nlhs,
                            const mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &grad, 2, &cd_emlrtRTEI);
  objfunSTM_S_energy(&st, *lam0, *X0, &b_physical, &boundary, *obj_data,
                     *(int32_T(*)[1]) & obj_size, grad);
  /* Marshall out global variables */
  MEXGlobalSyncOutFunction(true);
  /* Marshall function outputs */
  plhs[0] = b_emlrt_marshallOut(*obj_data, &obj_size);
  if (nlhs > 1) {
    grad->canFreeData = false;
    plhs[1] = c_emlrt_marshallOut(grad);
  }
  emxFree_real_T(&st, &grad);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

/* End of code generation (_coder_objfunSTM_S_energy_api.c) */
