...
static void e_binary_expand_op(real_T in1[2], const struct0_T *in2,
                               const emxArray_real_T *in3, int32_T in4);

static void f_binary_expand_op(real_T in1[2], const struct0_T *in2,
                               const emxArray_real_T *in3, int32_T in4);
...
real_T stopfuel(const emlrtStack *sp, const emxArray_real_T *s)
{
  ...
  if (physical.EPS > 0.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &md_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &rd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (EPS < 1.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &nd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (EPS != (int32_T)EPS) {
      emlrtIntegerCheckR2012b(EPS, &v_emlrtDCI, (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &od_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = (int32_T)EPS;
  }
  ...
  if ((i != 2) && (i != 1)) {
    emlrtDimSizeImpxCheckR2021b(2, i, &g_emlrtECI, (emlrtConstCTX)sp);
  }
  if (EPS < 1.0) {
    i1 = 0;
  } else {
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &pd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &qd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i1 = (int32_T)EPS;
  }
  ...
  indexShapeCheck(&st, s->size[0], iv);
  if ((i1 != 2) && (i1 != 1)) {
    emlrtDimSizeImpxCheckR2021b(2, i1, &h_emlrtECI, (emlrtConstCTX)sp);
  }
  if (i == 2) {
