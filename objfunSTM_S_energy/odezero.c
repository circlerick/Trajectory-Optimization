             ...
             boolean_T *stop)
{
  ...
  *vnew = stopfuel(&b_st, ynew);
  tR = tnew;
  emxInit_real_T(sp, &yR, 1, &rc_emlrtRTEI);
  i = yR->size[0];
  yR->size[0] = ynew->size[0];
  emxEnsureCapacity_real_T(sp, yR, i, &rc_emlrtRTEI);
  yR_data = yR->data;
  nrows = ynew->size[0];
  for (i = 0; i < nrows; i++) {
  ...
  ttry = tnew;
  lastmoved = 'N';
  emxInit_real_T(sp, &ytry, 1, &tc_emlrtRTEI);
    ...
    if (d != muDoubleScalarSign(vR)) {
      ...
      if (0.0 * absx >= 0.0) {
        ...
        if (tol_tmp <= tol) {
          ...
          tout->size[0] = 1;
          tout->size[1] = 1;
          emxEnsureCapacity_real_T(&st, tout, i, &sc_emlrtRTEI);
          ytry_data = tout->data;
          ...
          yout->size[0] = y->size[0];
          yout->size[1] = 1;
          emxEnsureCapacity_real_T(&st, yout, i, &sb_emlrtRTEI);
          yout_data = yout->data;
          b_st.site = &xh_emlrtRSI;
          for (i = 0; i < nrows; i++) {
            yout_data[i] = 0.0;
          ...
          iout->size[0] = 1;
          iout->size[1] = 1;
          emxEnsureCapacity_int32_T(&st, iout, i, &uc_emlrtRTEI);
          iout_data = iout->data;
          b_st.site = &xh_emlrtRSI;
          st.site = &th_emlrtRSI;
          ytry_data[0] = tR;
          ...
          *stop = (tL != t0);
          ...
          emxEnsureCapacity_real_T(&st, ytry, i, &tc_emlrtRTEI);
          ytry_data = ytry->data;
          nrows = y->size[0];
          for (i = 0; i < nrows; i++) {
          ...
          if ((d != muDoubleScalarSign(vtry)) && (0.0 * (vtry - vL) >= 0.0)) {
            ...
            emxEnsureCapacity_real_T(sp, yR, i, &vc_emlrtRTEI);
            yR_data = yR->data;
            nrows = ytry->size[0];
            for (i = 0; i < nrows; i++) {
