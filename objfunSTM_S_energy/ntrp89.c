                               ...
                               const emxArray_real_T *in4)
{
  ...
  emxInit_real_T(sp, &b_in1, 1, &ad_emlrtRTEI);
  i = b_in1->size[0];
  b_in1->size[0] = in4->size[0];
  emxEnsureCapacity_real_T(sp, b_in1, i, &ad_emlrtRTEI);
  b_in1_data = b_in1->data;
  stride_0_0 = (in1->size[0] != 1);
  loop_ub = in4->size[0];
  for (i = 0; i < loop_ub; i++) {
    b_in1_data[i] =
        in1_data[i * stride_0_0 + in1->size[0] * in2] + in3 * in4_data[i];
  }
              ...
              emxArray_real_T *yinterp)
{
  ...
  yinterp->size[1] = 7;
  emxEnsureCapacity_real_T(sp, yinterp, i, &xc_emlrtRTEI);
  ...
  emxInit_real_T(sp, &b, 1, &wc_emlrtRTEI);
  for (k = 0; k < 7; k++) {
    real_T b_b[14];
    real_T c_b;
    real_T theta;
    ...
    for (b_i = 0; b_i < 14; b_i++) {
      b_b[b_i] = ((((((dv[b_i] * theta + dv1[b_i]) * theta + dv2[b_i]) * theta +
                     dv3[b_i]) *
                        theta +
                    dv4[b_i]) *
                       theta +
    ...
    if (yinterp->size[0] == b->size[0]) {
      ...
      emxEnsureCapacity_real_T(sp, b, i, &ad_emlrtRTEI);
      b_data = b->data;
      for (i = 0; i < b_i; i++) {
      ...
      st.site = &vh_emlrtRSI;
      h_binary_expand_op(&st, yinterp, k, h, b);
      yinterp_data = yinterp->data;
    }
  }
  emxFree_real_T(sp, &b);
                        ...
                        real_T in3, const emxArray_real_T *in4)
{
  ...
  loop_ub = in4->size[0];
  for (i = 0; i < loop_ub; i++) {
    in1_data[i] = in2_data[i * stride_0_0] + in3 * in4_data[i];
  }
}
            ...
            emxArray_real_T *yinterp, emxArray_real_T *ypinterp)
{
  ...
  ypinterp->size[1] = 13;
  emxEnsureCapacity_real_T(sp, ypinterp, i, &yc_emlrtRTEI);
