...
void b_mtimes(const emlrtStack *sp, const real_T A[20],
              const emxArray_real_T *B, emxArray_real_T *C)
{
  ...
  if ((B->size[0] == 0) || (B->size[1] == 0)) {
    ...
    C->size[0] = 4;
    C->size[1] = B->size[1];
    emxEnsureCapacity_real_T(sp, C, i, &bd_emlrtRTEI);
    C_data = C->data;
    loop_ub = B->size[1] << 2;
    for (i = 0; i < loop_ub; i++) {
      C_data[i] = 0.0;
    ...
    C->size[0] = 4;
    C->size[1] = B->size[1];
    emxEnsureCapacity_real_T(&b_st, C, i, &ec_emlrtRTEI);
    C_data = C->data;
...
void c_mtimes(const emlrtStack *sp, const real_T A[5], const emxArray_real_T *B,
              emxArray_real_T *C)
{
  ptrdiff_t k_t;
  ptrdiff_t lda_t;
