...
function xxd= derivatives_NOG(inp1,inp2,inp3)
% Inputs: 
...
[H_x_per,H_p_per]=HamiltonianFirstDerivatives(x_per,p_per,Sper,physical); 
[~,dSdt]= Switching_Function(x_per,p_per,physical);
pd_per=-H_x_per(1:NSTATE,1);
xd_per=H_p_per(1:NSTATE,1);

xxd = [xd_nom;pd_nom;xd_per;pd_per;dUN;dVN;dUn;dVn;dSdt];