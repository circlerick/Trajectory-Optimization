             ...
             const emxArray_real_T *in2, real_T Tsym, real_T csym)
{
  ...
  if (in2->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2->size[0], &li_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in2->size[0], &ki_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in2->size[0], &ji_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1->size[0], &ii_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  t2 = 1.0 / csym;
  st.site = &ub_emlrtRSI;
