              ...
              const emxArray_real_T *in2, real_T Tsym, real_T d2S_dpdp[25])
{
  ...
  if (in2->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2->size[0], &ei_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in2->size[0], &di_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1->size[0], &ci_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
