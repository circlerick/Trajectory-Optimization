              ...
              real_T dH0_dp[5])
{
  ...
  if (in1->size[0] < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1->size[0], &yg_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in1->size[0], &xg_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in1->size[0], &wg_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in1->size[0], &vg_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  st.site = &jg_emlrtRSI;
