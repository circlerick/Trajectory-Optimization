             ...
             const emxArray_real_T *in2, real_T Tsym, real_T csym)
{
  ...
  if (in2->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2->size[0], &jb_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in2->size[0], &ib_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in2->size[0], &hb_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1->size[0], &gb_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  st.site = &t_emlrtRSI;
