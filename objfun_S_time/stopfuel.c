...
real_T stopfuel(const emlrtStack *sp, const emxArray_real_T *s)
{
  ...
  if (physical.EPS > 0.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &fd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &kd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (EPS < 1.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &gd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (EPS != (int32_T)EPS) {
      emlrtIntegerCheckR2012b(EPS, &eb_emlrtDCI, (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &hd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = (int32_T)EPS;
  }
  ...
  if ((i != 2) && (i != 1)) {
    emlrtDimSizeImpxCheckR2021b(2, i, &s_emlrtECI, (emlrtConstCTX)sp);
  }
  if (EPS < 1.0) {
    i1 = 0;
  } else {
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &id_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &jd_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i1 = (int32_T)EPS;
  }
  ...
  indexShapeCheck(&st, s->size[0], iv);
  if ((i1 != 2) && (i1 != 1)) {
    emlrtDimSizeImpxCheckR2021b(2, i1, &t_emlrtECI, (emlrtConstCTX)sp);
  }
  if (i == 2) {
