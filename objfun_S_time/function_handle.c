                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  emxInit_real_T(sp, &r, 1, &je_emlrtRTEI);
  st.site = (emlrtRSInfo *)&in2;
  objfun_S_time_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, r);
  b_in9_data = r->data;
                         ...
                         const emxArray_real_T *in13)
{
  ...
  st.site = (emlrtRSInfo *)&in2;
  objfun_S_time_anonFcn4(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
  emxFree_real_T(sp, &b_in9);
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtConstCTX)sp);
}
                         ...
                         const emxArray_real_T *in12)
{
  ...
  emxInit_real_T(sp, &r, 1, &je_emlrtRTEI);
  st.site = (emlrtRSInfo *)&in2;
  objfun_S_time_anonFcn4(&st, in3, in4, in5, in6, in7, in8, b_in9, r);
  b_in9_data = r->data;
  emxFree_real_T(sp, &b_in9);
  loop_ub = r->size[0];
  for (i = 0; i < loop_ub; i++) {
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &td_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &td_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                        ...
                        const emxArray_real_T *in13)
{
  ...
  st.site = (emlrtRSInfo *)&in2;
  objfun_S_time_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
  emxFree_real_T(sp, &b_in9);
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtConstCTX)sp);
}
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &rd_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &rd_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
