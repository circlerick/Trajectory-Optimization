 ...
 *
 * objfun_S_time_emxutil.c
 *
 * Code generation for function 'objfun_S_time_emxutil'
 *
 */
...
{
  emxFree_real_T(sp, &pStruct->Earth);
  emxFree_real_T(sp, &pStruct->Moon);
  emxFree_real_T(sp, &pStruct->g0_x);
}

void emxFreeStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct)
{
  emxFree_real_T(sp, &pStruct->A);
  emxFree_real_T(sp, &pStruct->Xf);
  emxFree_real_T(sp, &pStruct->X0);
  emxFree_real_T(sp, &pStruct->Sigma);
  emxFree_real_T(sp, &pStruct->Pigreco);
  emxFree_real_T(sp, &pStruct->g0_xx);
}

void emxFreeStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct)
{
  emxFree_char_T(sp, &pStruct->problem);
  emxFree_real_T(sp, &pStruct->steps);
  emxFree_real_T(sp, &pStruct->box_lb);
  emxFree_real_T(sp, &pStruct->box_ub);
}
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->Earth, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->Moon, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->g0_x, 1, srcLocation);
}

void emxInitStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->A, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->Xf, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->X0, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->Sigma, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->Pigreco, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->g0_xx, 2, srcLocation);
}

void emxInitStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_char_T(sp, &pStruct->problem, srcLocation);
  emxInit_real_T(sp, &pStruct->steps, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->box_lb, 1, srcLocation);
  emxInit_real_T(sp, &pStruct->box_ub, 1, srcLocation);
}
...
/* End of code generation (objfun_S_time_emxutil.c) */
