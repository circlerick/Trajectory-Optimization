 ...
 *
 * objfun_S_time_initialize.c
 *
 * Code generation for function 'objfun_S_time_initialize'
 *
 */
...
static void objfun_S_time_once(const emlrtStack *sp);
...
void objfun_S_time_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    objfun_S_time_once(&st);
  }
}

/* End of code generation (objfun_S_time_initialize.c) */
