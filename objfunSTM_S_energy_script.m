% OBJFUNSTM_S_ENERGY_SCRIPT   Generate MEX-function objfunSTM_S_energy_mex from
%  objfunSTM_S_energy.
% 
% Script generated from project 'objfunSTM_S_energy.prj' on 24-Jul-2024.
% 
...
%% Define argument types for entry-point 'objfunSTM_S_energy'.
ARGS = cell(1,1);
ARGS{1} = cell(4,1);
...
codegen -config cfg objfunSTM_S_energy -args ARGS{1}
