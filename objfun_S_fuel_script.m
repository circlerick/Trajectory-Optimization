% OBJFUN_S_FUEL_SCRIPT   Generate MEX-function objfun_S_fuel_mex from
%  objfun_S_fuel.
% 
% Script generated from project 'objfun_S_fuel.prj' on 24-Jul-2024.
% 
...
%% Define argument types for entry-point 'objfun_S_fuel'.
ARGS = cell(1,1);
ARGS{1} = cell(4,1);
...
codegen -config cfg objfun_S_fuel -args ARGS{1}
