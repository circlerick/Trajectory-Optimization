 ...
 *
 * objfun_S_fuel_initialize.c
 *
 * Code generation for function 'objfun_S_fuel_initialize'
 *
 */
...
static void objfun_S_fuel_once(const emlrtStack *sp);
...
void objfun_S_fuel_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    objfun_S_fuel_once(&st);
  }
}

/* End of code generation (objfun_S_fuel_initialize.c) */
