              ...
              const real_T in2_data[], int32_T in2_size, real_T dH0_dx[5])
{
  ...
  if (in2_size < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in2_size, &mb_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2_size < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, 1, &lb_emlrtBCI, (emlrtConstCTX)sp);
  }
  if (in2_size < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, 2, &kb_emlrtBCI, (emlrtConstCTX)sp);
  }
  if (in2_size < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, 3, &jb_emlrtBCI, (emlrtConstCTX)sp);
  }
  if (in1_size < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1_size, &ib_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1_size < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, 1, &hb_emlrtBCI, (emlrtConstCTX)sp);
  }
  t2 = in1_data[0] * 2.0;
  st.site = &rb_emlrtRSI;
