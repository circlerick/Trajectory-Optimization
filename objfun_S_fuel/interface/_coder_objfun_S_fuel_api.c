 ...
 *
 * _coder_objfun_S_fuel_api.c
 *
 * Code generation for function '_coder_objfun_S_fuel_api'
 *
 */
...
static emlrtRTEInfo mb_emlrtRTEI = {
    1,                          /* lineNo */
    1,                          /* colNo */
    "_coder_objfun_S_fuel_api", /* fName */
    ""                          /* pName */
};
...
void objfun_S_fuel_api(objfun_S_fuelStackData *SD, const mxArray *const prhs[4],
                       int32_T nlhs, const mxArray *plhs[3])
{
  ...
  emxInit_real_T(&st, &states, 2, &mb_emlrtRTEI);
  emxInit_real_T(&st, &times, 1, &mb_emlrtRTEI);
  objfun_S_fuel(SD, &st, *lam0, *X0, &b_physical, &boundary, &obj, states,
                times);
  /* Marshall out global variables */
...
/* End of code generation (_coder_objfun_S_fuel_api.c) */
