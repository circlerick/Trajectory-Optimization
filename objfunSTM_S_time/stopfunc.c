...
void f_binary_expand_op(real_T in1[2], const struct0_T *in2,
...
void g_binary_expand_op(real_T in1[2], const struct0_T *in2,
                        const emxArray_real_T *in3, int32_T in4)
{
  const real_T *in3_data;
  in3_data = in3->data;
...
real_T stopfunc(const emlrtStack *sp, const emxArray_real_T *s)
{
  ...
  if (d < 1.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &oe_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (d != (int32_T)d) {
    ...
    if (((int32_T)d < 1) || ((int32_T)d > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)d, 1, s->size[0], &pe_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = (int32_T)d;
  }
  ...
  if (y < physical.RE) {
    ...
    if (d < 1.0) {
      ...
      if (s->size[0] < 1) {
        emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &qe_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      if (((int32_T)d < 1) || ((int32_T)d > s->size[0])) {
        emlrtDynamicBoundsCheckR2012b((int32_T)d, 1, s->size[0], &re_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      i = (int32_T)d;
    }
    ...
    indexShapeCheck(&st, s->size[0], iv);
    if ((i != 2) && (i != 1)) {
      emlrtDimSizeImpxCheckR2021b(2, i, &o_emlrtECI, (emlrtConstCTX)sp);
    }
    if (i == 2) {
