                         ...
                         const emxArray_real_T *in11)
{
  ...
  emxInit_real_T(sp, &b_in9, 1, &xe_emlrtRTEI);
  i = b_in9->size[0];
  b_in9->size[0] = in11->size[0];
  emxEnsureCapacity_real_T(sp, b_in9, i, &xe_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  loop_ub = in11->size[0];
  for (i = 0; i < loop_ub; i++) {
    b_in9_data[i] = in9_data[i * stride_0_0] + in10 * in11_data[i];
  }
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_time_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &sf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &sf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  ...
  emxInit_real_T(sp, &r, 1, &xf_emlrtRTEI);
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_time_anonFcn4(&st, in3, in4, in5, in6, in7, in8, b_in9, r);
  b_in9_data = r->data;
  emxFree_real_T(sp, &b_in9);
  loop_ub = r->size[0];
  for (i = 0; i < loop_ub; i++) {
                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &wf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    b_in9->size[0] = in9->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &wf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  if (in1->size[0] == 1) {
  ...
  emxInit_real_T(sp, &r, 1, &xf_emlrtRTEI);
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_time_anonFcn2(&st, in3, in4, in5, in6, in7, in8, b_in9, r);
  b_in9_data = r->data;
  emxFree_real_T(sp, &b_in9);
  loop_ub = r->size[0];
  for (i = 0; i < loop_ub; i++) {
                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &vf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    b_in9->size[0] = in9->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &vf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  if (in1->size[0] == 1) {
                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &uf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    b_in9->size[0] = in9->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &uf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  if (in1->size[0] == 1) {
                         ...
                         const emxArray_real_T *in9, real_T in10)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &tf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    b_in9->size[0] = in9->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &tf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  if (in1->size[0] == 1) {
                         ...
                         const emxArray_real_T *in13)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &nf_emlrtRTEI);
  i = b_in9->size[0];
  if (in11->size[0] == 1) {
    if (in13->size[0] == 1) {
      if (in12->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &nf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  ...
  st.site = (emlrtRSInfo *)&in2;
  objfunSTM_S_time_anonFcn4(&st, in3, in4, in5, in6, in7, in8, b_in9, in1);
  emxFree_real_T(sp, &b_in9);
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtConstCTX)sp);
}
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &lf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &lf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &kf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &kf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &jf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &jf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &if_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &if_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &hf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &hf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &gf_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &gf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &ff_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in11->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &ff_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &ef_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    if (in11->size[0] == 1) {
      stride_0_0 = in1->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &ef_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in1->size[0] != 1);
  stride_2_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in13)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &df_emlrtRTEI);
  i = b_in9->size[0];
  if (in13->size[0] == 1) {
    if (in12->size[0] == 1) {
      if (in1->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &df_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
                         ...
                         const emxArray_real_T *in13)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &cf_emlrtRTEI);
  i = b_in9->size[0];
  if (in13->size[0] == 1) {
    if (in12->size[0] == 1) {
      stride_0_0 = in11->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &cf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in12->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &bf_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    if (in1->size[0] == 1) {
      stride_0_0 = in11->size[0];
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &bf_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in1->size[0] != 1);
                         ...
                         const emxArray_real_T *in12)
{
  ...
  in9_data = in9->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &af_emlrtRTEI);
  i = b_in9->size[0];
  if (in12->size[0] == 1) {
    stride_0_0 = in11->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &af_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in12->size[0] != 1);
                         ...
                         const emxArray_real_T *in11)
{
  ...
  in1_data = in1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtConstCTX)sp);
  emxInit_real_T(sp, &b_in9, 1, &ye_emlrtRTEI);
  i = b_in9->size[0];
  if (in1->size[0] == 1) {
    stride_0_0 = in11->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(sp, b_in9, i, &ye_emlrtRTEI);
  b_in9_data = b_in9->data;
  stride_0_0 = (in9->size[0] != 1);
  stride_1_0 = (in11->size[0] != 1);
  stride_2_0 = (in1->size[0] != 1);
