...
static emlrtRTEInfo pc_emlrtRTEI =
    {
        ...
        "eye", /* fName */
        "C:\\Program "
        "Files\\MATLAB\\R2022b\\toolbox\\eml\\lib\\matlab\\elmat\\eye.m" /* pName
                                                                          */
};
...
void eye(const emlrtStack *sp, real_T varargin_1, emxArray_real_T *b_I)
{
  ...
  if (!(d <= 2.147483647E+9)) {
    emlrtErrorWithMessageIdR2018a(&b_st, &e_emlrtRTEI, "Coder:MATLAB:pmaxsize",
  ...
  emxEnsureCapacity_real_T(sp, b_I, i, &pc_emlrtRTEI);
  I_data = b_I->data;
