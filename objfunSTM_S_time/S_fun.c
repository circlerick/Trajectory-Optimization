             ...
             const emxArray_real_T *in2, real_T Tsym, real_T csym)
{
  ...
  if (in2->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2->size[0], &ff_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in2->size[0], &ef_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in2->size[0], &df_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 5) {
    emlrtDynamicBoundsCheckR2012b(5, 1, in1->size[0], &cf_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  st.site = &nb_emlrtRSI;
  ...
  return -Tsym * (in2_data[4] / csym - x / in1_data[4]);
}
