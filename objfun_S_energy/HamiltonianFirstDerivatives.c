                                 ...
                                 emxArray_real_T *H_x, emxArray_real_T *H_p)
{
  ...
  if (!(physical_NSTATE >= 0.0)) {
    emlrtNonNegativeCheckR2012b(physical_NSTATE, &o_emlrtDCI,
                                (emlrtConstCTX)sp);
  }
  if (physical_NSTATE != (int32_T)muDoubleScalarFloor(physical_NSTATE)) {
    emlrtIntegerCheckR2012b(physical_NSTATE, &p_emlrtDCI, (emlrtConstCTX)sp);
  }
  if (physical_EPS > 0.0) {
    if ((S < physical_EPS * physical_Tmax / physical_c) &&
      ...
      if (p_size < 3) {
        emlrtDynamicBoundsCheckR2012b(3, 1, p_size, &ib_emlrtBCI, &st);
      }
      if (p_size < 4) {
        emlrtDynamicBoundsCheckR2012b(4, 1, 3, &hb_emlrtBCI, &st);
      }
      if (p_size < 5) {
        emlrtDynamicBoundsCheckR2012b(5, 1, 4, &gb_emlrtBCI, &st);
      }
      if (x_size < 5) {
        emlrtDynamicBoundsCheckR2012b(5, 1, x_size, &fb_emlrtBCI, &st);
      }
