 ...
 *
 * _coder_objfun_S_energy_api.c
 *
 * Code generation for function '_coder_objfun_S_energy_api'
 *
 */
...
#include "objfun_S_energy_mexutil.h"
...
static emlrtRTEInfo lb_emlrtRTEI = {
    1,                            /* lineNo */
    1,                            /* colNo */
    "_coder_objfun_S_energy_api", /* fName */
    ""                            /* pName */
};
...
static const mxArray *b_emlrt_marshallOut(const struct0_T *u)
{
  ...
  emlrtSetFieldR2017b(y, 0, "Tmax", emlrt_marshallOut(u->Tmax), 0);
  emlrtSetFieldR2017b(y, 0, "g", emlrt_marshallOut(u->g), 1);
  emlrtSetFieldR2017b(y, 0, "mu", emlrt_marshallOut(u->mu), 2);
  emlrtSetFieldR2017b(y, 0, "RE", emlrt_marshallOut(u->RE), 3);
  emlrtSetFieldR2017b(y, 0, "RM", emlrt_marshallOut(u->RM), 4);
  emlrtSetFieldR2017b(y, 0, "c", emlrt_marshallOut(u->c), 5);
  b_y = NULL;
  ...
  emlrtSetFieldR2017b(y, 0, "NSTATE", emlrt_marshallOut(u->NSTATE), 8);
  emlrtSetFieldR2017b(y, 0, "shoot", emlrt_marshallOut(u->shoot), 9);
  d_y = NULL;
  ...
  emlrtSetFieldR2017b(y, 0, "EPS", emlrt_marshallOut(u->EPS), 11);
  return y;
}
...
void objfun_S_energy_api(objfun_S_energyStackData *SD,
                         ...
                         const mxArray *plhs[3])
{
  ...
  emxInit_real_T(&st, &states, 2, &lb_emlrtRTEI);
  emxInit_real_T(&st, &times, 1, &lb_emlrtRTEI);
  objfun_S_energy(SD, &st, *lam0, *X0, &b_physical, &boundary, &obj, states,
                  times);
  /* Marshall out global variables */
  ...
  if (nlhs > 1) {
    ...
    plhs[1] = c_emlrt_marshallOut(states);
  }
  emxFree_real_T(&st, &states);
  if (nlhs > 2) {
    times->canFreeData = false;
    plhs[2] = d_emlrt_marshallOut(times);
  }
  emxFree_real_T(&st, &times);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

/* End of code generation (_coder_objfun_S_energy_api.c) */
