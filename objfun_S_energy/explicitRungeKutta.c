                       ...
                       int32_T *nfevals)
{
  ...
  emxInit_real_T(&d_st, &r, 1, &pb_emlrtRTEI);
  e_st.site = &t_emlrtRSI;
  objfun_S_energy_anonFcn2(
                         ...
                         int32_T *nfevals, real_T fC[11], real_T fE[11])
{
  ...
  emxInit_real_T(&d_st, &f2, 1, &mb_emlrtRTEI);
  e_st.site = &t_emlrtRSI;
  objfun_S_energy_anonFcn2(
      &e_st, c_df_workspace_ODEFunction_work, d_df_workspace_ODEFunction_work,
      e_df_workspace_ODEFunction_work, f_df_workspace_ODEFunction_work,
  ...
  if (f2->size[0] == 11) {
    ...
    e_st.site = &t_emlrtRSI;
    s_binary_expand_op(
        &e_st, f2, t_emlrtRSI, c_df_workspace_ODEFunction_work,
  ...
  c_st.site = &u_emlrtRSI;
  d_st.site = &v_emlrtRSI;
  emxInit_real_T(&d_st, &f4, 1, &nb_emlrtRTEI);
  if (f2->size[0] == 11) {
    for (i = 0; i < 11; i++) {
    ...
    e_st.site = &t_emlrtRSI;
    r_binary_expand_op(
        &e_st, f4, t_emlrtRSI, c_df_workspace_ODEFunction_work,
        d_df_workspace_ODEFunction_work, e_df_workspace_ODEFunction_work,
        f_df_workspace_ODEFunction_work, g_df_workspace_ODEFunction_work,
  ...
  c_st.site = &u_emlrtRSI;
  d_st.site = &v_emlrtRSI;
  emxInit_real_T(&d_st, &f6, 1, &ob_emlrtRTEI);
  if ((f4->size[0] == 11) && (f2->size[0] == 11)) {
    ...
    e_st.site = &t_emlrtRSI;
    p_binary_expand_op(
        &e_st, f6, t_emlrtRSI, c_df_workspace_ODEFunction_work,
        d_df_workspace_ODEFunction_work, e_df_workspace_ODEFunction_work,
        f_df_workspace_ODEFunction_work, g_df_workspace_ODEFunction_work,
