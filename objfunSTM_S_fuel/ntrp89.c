              ...
              emxArray_real_T *yinterp)
{
  ...
  yinterp->size[1] = 7;
  emxEnsureCapacity_real_T(sp, yinterp, i, &ld_emlrtRTEI);
  ...
  for (k = 0; k < 7; k++) {
    ...
    if (yinterp->size[0] == b->size[0]) {
      ...
      emxEnsureCapacity_real_T(sp, b, i, &nd_emlrtRTEI);
      b_data = b->data;
      for (i = 0; i < b_i; i++) {
      ...
      st.site = &fi_emlrtRSI;
      j_binary_expand_op(&st, yinterp, k, h, b);
      yinterp_data = yinterp->data;
    }
  }
  emxFree_real_T(sp, &b);
...
void i_binary_expand_op(emxArray_real_T *in1, const emxArray_real_T *in2,
            ...
            emxArray_real_T *yinterp, emxArray_real_T *ypinterp)
{
  ...
  ypinterp->size[1] = 13;
  emxEnsureCapacity_real_T(sp, ypinterp, i, &md_emlrtRTEI);
