...
static void g_binary_expand_op(real_T in1[2], const struct0_T *in2,
                               const emxArray_real_T *in3, int32_T in4);

static void h_binary_expand_op(real_T in1[2], const struct0_T *in2,
                               const emxArray_real_T *in3, int32_T in4);
...
real_T stopfuel(const emlrtStack *sp, const emxArray_real_T *s)
{
  ...
  if (physical.EPS > 0.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &ae_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(s->size[0], 1, s->size[0], &fe_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (EPS < 1.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &be_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (EPS != (int32_T)EPS) {
      emlrtIntegerCheckR2012b(EPS, &hb_emlrtDCI, (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &ce_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i = (int32_T)EPS;
  }
  ...
  if (EPS < 1.0) {
    ...
    if (s->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(1, 1, s->size[0], &de_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    if (((int32_T)EPS < 1) || ((int32_T)EPS > s->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)EPS, 1, s->size[0], &ee_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    i1 = (int32_T)EPS;
  }
  ...
  indexShapeCheck(&st, s->size[0], iv);
  if ((i1 != 2) && (i1 != 1)) {
    emlrtDimSizeImpxCheckR2021b(2, i1, &k_emlrtECI, (emlrtConstCTX)sp);
  }
  if (i == 2) {
    x[0] = physical.Earth[0] - s_data[0];
    x[1] = physical.Earth[1] - s_data[1];
  } else {
    h_binary_expand_op(x, &physical, s, 1);
  }
