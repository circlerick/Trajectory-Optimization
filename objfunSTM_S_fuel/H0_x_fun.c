              ...
              const emxArray_real_T *in2, real_T dH0_dx[5])
{
  ...
  if (in2->size[0] < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in2->size[0], &ic_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in2->size[0], &hc_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 3) {
    emlrtDynamicBoundsCheckR2012b(3, 1, in2->size[0], &gc_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in2->size[0] < 4) {
    emlrtDynamicBoundsCheckR2012b(4, 1, in2->size[0], &fc_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 1) {
    emlrtDynamicBoundsCheckR2012b(1, 1, in1->size[0], &ec_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  if (in1->size[0] < 2) {
    emlrtDynamicBoundsCheckR2012b(2, 1, in1->size[0], &dc_emlrtBCI,
                                  (emlrtConstCTX)sp);
  }
  t2 = in1_data[0] * 2.0;
  st.site = &bd_emlrtRSI;
