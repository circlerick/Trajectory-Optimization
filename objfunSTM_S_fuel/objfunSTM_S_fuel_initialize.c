 ...
 *
 * objfunSTM_S_fuel_initialize.c
 *
 * Code generation for function 'objfunSTM_S_fuel_initialize'
 *
 */
...
static void objfunSTM_S_fuel_once(const emlrtStack *sp);
...
void objfunSTM_S_fuel_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    objfunSTM_S_fuel_once(&st);
  }
}

/* End of code generation (objfunSTM_S_fuel_initialize.c) */
